...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Devised automation software, PCBs, electrical harnessing, and mechanical parts supporting the \MYhref{http://uvrockets.colorado.edu/}{CU UV Rockets group}}
